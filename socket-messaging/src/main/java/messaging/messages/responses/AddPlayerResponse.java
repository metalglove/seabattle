...
public class AddPlayerResponse extends Message {
    private final Integer playerNumber;
    private final Integer opponentPlayerNumber;
    private final String opponentName;
    private final boolean duplicate;

    public AddPlayerResponse(Integer playerNumber, boolean success, Integer opponentPlayerNumber, String opponentName, boolean duplicate) {
